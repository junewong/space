...
Map.prototype = {
	...
	setValue : function( x0, y0, w0, h0, value ) {
		...
		var w = Math.ceil( w0 / this.tileSize );
		var h = Math.ceil( h0 / this.tileSize );
	...
	checkObstacal : function( x1, y1, x2, y2 ) {
		var angle = Math.asin( y2 - y1, x2 - x1 );
		...
		while ( offset < distance ) {
			...
			var x = x1 + xLen * xDirection;
			var y = y1 + yLen * yDirection;
